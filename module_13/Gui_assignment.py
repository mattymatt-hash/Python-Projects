...
# this will define where the layout starts and how it expands to fill the screen when the user wants the going bigger
total_columns = 5
...
# Start button
start_btn = tk.Button(window, text="Start Game", command=start_game, bg="green", fg="white")
